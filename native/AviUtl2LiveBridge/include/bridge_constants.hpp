...
inline constexpr std::string_view kPluginVersion = "0.10.0";
...
inline constexpr std::size_t kMaxFrameMarks = 256U;
inline constexpr std::size_t kMaxMarkMemoCharacters = 1024U;
inline constexpr std::size_t kMaxMarkMemoBytes = 4096U;
